...
def ford_fulkerson_page(request):
    # Thêm tên thư mục con vào đường dẫn
    # Sửa dòng return render thành:
    return render(request, 'graphs/algorithms_d3/ford_fulkerson/ford_fulkerson.html')

# 2. API xử lý thuật toán
@csrf_exempt
...
# 3. API ĐỌC FILE PDF THẬT


def get_ford_fulkerson_pdf(request):
    try:
        # Tên file chính xác theo ảnh của bạn
